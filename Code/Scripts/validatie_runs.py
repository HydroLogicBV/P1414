...
def refresh_data(cmd):
    p = Popen(
        cmd,
        cwd=r"D:\Work\git\GIS_tools\Code\Scripts",
        shell=True,
...
if __name__ == "__main__":
    ...
    file_list = [
        "combined_model_WBD",
        "combined_model_WBD_HD",
        "combined_model_NZ_KW",
        "combined_model_NZ_HHD",
        "combined_model_Markermeer",
        "combined_model_Krimpenerwaard",
    ]
