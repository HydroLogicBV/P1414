...
gpkg_file = folder_path_GIS + r"\GIS\HYDAMO\Combined_test_v16_KW.gpkg"
gpkgs_list = [
    ...
    folder_path_GIS + r"\GIS\HYDAMO\RMM_closed.gpkg",
...
output_folder = folder_path_output + r"\Models\Combined\V16_HHR"
