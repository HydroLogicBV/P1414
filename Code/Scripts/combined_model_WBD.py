...
gpkg_file = folder_path_GIS + r"\GIS\HYDAMO\Combined_30_oktober.gpkg"
#gpkg_file = folder_path_GIS + r"\GIS\HYDAMO\HDSR_30_oktober.gpkg"

gpkgs_list = [
    folder_path_GIS + r"\GIS\HYDAMO\HHSK_30_oktober_no_coupuresV2.gpkg",
    folder_path_GIS + r"\GIS\HYDAMO\HDSR_30_oktober.gpkg",
    ...
    folder_path_GIS + r"\GIS\HYDAMO\Buitenwater_28_oktober.gpkg",
    # folder_path_GIS + r"\GIS\HYDAMO\tunnels.gpkg",
    # folder_path_GIS + r"\GIS\HYDAMO\Ontbrekende_stuwen.gpkg",
    folder_path_GIS + r"\GIS\HYDAMO\Tunnels_Onderdoorgangen_30_oktober.gpkg",           # Should not be validated!
...
output_folder = folder_path_output + r"\Combined_V2.3_500m_ALL_no_coupures"
...
snap_dist_list = [0, 0, 10, 10, 50, 100, 0]
defaults = r"defaults"
