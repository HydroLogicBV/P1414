...
class Models:
    class FM:
        ...
        class two_d:
            ...
            initial_peil_raster_path = folder_path_GIS + r"\GIS\peilen\wd_0_v7.tif"
        ...
        class hydrolib_core_options:
            class external_forcing:
                ...
                __fb1 = QHTable(
                    name="172541.440000_513910.400000",
                    quantityunitpair=[
                ...
                __boundary1 = Boundary(
                        quantity="qhbnd",
                        nodeid="172541.440000_513910.400000",
