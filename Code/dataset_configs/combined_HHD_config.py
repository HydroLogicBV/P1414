...
class Models:
    class FM:
        ...
        class two_d:
            ...
            clip_buffer = 0.5*dx                                                     # int, buffer around the polygons that must be clipped in [meters], often 0.5*grid size works to get a sharp clip
            clip_selection = ['> 125 meter', '50 - 125 meter']                    # selection of the buffer layer that will be clipped, based on the 'breedtekla' column in the shapefile
