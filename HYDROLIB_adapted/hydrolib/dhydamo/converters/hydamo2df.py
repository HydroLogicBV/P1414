    ...
    def weirs(
        ...
        for weir in rweirs.itertuples():
            ...
            if weir_mandev.overlaatonderlaat.to_string(index=False) == "Overlaat":
                self.structures.add_rweir(
                    ...
                    crestlevel=weir_opening.hoogstedoorstroomhoogte.values[0],
                    crestwidth=weir_opening.hoogstedoorstroombreedte.values[0],
        ...
        for uweir in uweirs.itertuples():
            ...
            self.structures.add_uweir(
                ...
                crestlevel=uweir.hoogstedoorstroomhoogte,
